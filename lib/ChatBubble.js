  ...
  _createClass(ChatBubble, [{
    ...
    value: function getConversations(component, messages) {
      ...
      var listItems = messages.map(function (message, index) {
        ...
        if (text != '') {
          if (isImageTag) {
            return _react2.default.createElement('div', { className: 'bubble-container ' + bubbleDirection, key: index }, _react2.default.createElement('img', { className: 'img-circle ' + bubbleClass, src: message.type === 1 ? component.state.targetUser.avatar : component.state.currentUser.avatar }), _react2.default.createElement('div', { id: component.renderHastag ? 'tag_' + message.mid : message.mid, className: 'bubble-img img-' + bubbleClass }, _Parser(text)), _react2.default.createElement('div', { className: component.renderHastag ? 'menu-box' : 'menu-box-hidden' }, _react2.default.createElement('div', { className: 'tools tools--hidden' }, _react2.default.createElement('div', { className: 'tool',
          ...
          return _react2.default.createElement('div', { className: 'bubble-container ' + bubbleDirection, key: index }, _react2.default.createElement('img', { className: 'img-circle ' + bubbleClass, src: message.type === 1 ? component.state.targetUser.avatar : component.state.currentUser.avatar }), _react2.default.createElement('div', { id: component.renderHastag ? 'tag_' + message.mid : message.mid, className: 'bubble-link bubble ' + bubbleClass }, _Parser(text)), _react2.default.createElement('div', { className: component.renderHastag ? 'menu-box' : 'menu-box-hidden' }, _react2.default.createElement('div', { className: 'tools tools--hidden' }, _react2.default.createElement('div', { className: 'tool',
            onClick: component.handleHashTagToolClick.bind(messID) }, _Parser(hashTagItem))), _react2.default.createElement(_hashTagInput.WithContext, { tags: message.tags,
            handleDelete: component.handleDeleteTag.bind(messObj),
            handleAddition: component.handleAdditionTag.bind(messObj),
            handleDrag: component.handleDragTag.bind(component) }), _react2.default.createElement('div', { onClick: component.handleEllipsClick.bind(messID) }, _Parser(ellipsItem))), _react2.default.createElement('div', { className: 'time-' + bubbleClass }, timeFormatted));
          ...
          if (elements.length > 0) {
            if (!allIsEmoji) {
              return _react2.default.createElement('div', { className: 'bubble-container ' + bubbleDirection, key: index }, _react2.default.createElement('img', { className: 'img-circle ' + bubbleClass,
                src: message.type === 1 ? component.state.targetUser.avatar : component.state.currentUser.avatar }), _react2.default.createElement('div', { id: component.renderHastag ? 'tag_' + message.mid : message.mid, className: 'bubble ' + bubbleClass }, elements.map(function (element) {
              ...
              return _react2.default.createElement('div', { className: 'bubble-container ' + bubbleDirection, key: index }, _react2.default.createElement('img', { className: 'img-circle ' + bubbleClass, src: message.type === 1 ? component.state.targetUser.avatar : component.state.currentUser.avatar }), _react2.default.createElement('div', { className: 'bubble-emoji bubble-emoji-' + bubbleClass }, elements.map(function (element) {
                if (element.type == 'emoji') {
          ...
          return _react2.default.createElement('div', { className: 'bubble-container ' + bubbleDirection, key: index }, _react2.default.createElement('img', { className: 'img-circle ' + bubbleClass, src: message.type === 1 ? component.state.targetUser.avatar : component.state.currentUser.avatar }), _react2.default.createElement('div', { id: component.renderHastag ? 'tag_' + message.mid : message.mid, className: 'bubble ' + bubbleClass }, _react2.default.createElement('p', { className: 'text-content' }, message.content)), _react2.default.createElement('div', { className: component.renderHastag ? 'menu-box' : 'menu-box-hidden' }, _react2.default.createElement('div', { className: 'tools tools--hidden' }, _react2.default.createElement('div', { className: 'tool',
            onClick: component.handleHashTagToolClick.bind(messID) }, _Parser(hashTagItem))), _react2.default.createElement(_hashTagInput.WithContext, { tags: message.tags,
            handleDelete: component.handleDeleteTag.bind(messObj),
            handleAddition: component.handleAdditionTag.bind(messObj),
            handleDrag: component.handleDragTag.bind(component) }), _react2.default.createElement('div', { onClick: component.handleEllipsClick.bind(messID) }, _Parser(ellipsItem))), _react2.default.createElement('div', { className: 'time-' + bubbleClass }, timeFormatted));
