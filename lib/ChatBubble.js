      ...
      var listItems = messages.map(function (message, index) {
        ...
        if (message.contentType != '') {
          if (message.contentType.indexOf('image') !== -1) {
            ...
            if (parseFloat(message.width) > 500 || parseFloat(message.height) > 500 ) {
              ...
              var ratioForWidth = parseFloat(message.width) / 500;
          ...
          while (match = regex.exec(message.text)) {
            ...
            if (_emoji.emojiIndex.search(colonsCore).length > 0){
              emoji.type = 'emoji';
              emoji.emoji = colons;
              elements.push(emoji);
            }
        ...
        if (text != '') {
          if (isImageTag) {
            return _react2.default.createElement(
              ...
              _react2.default.createElement('img', { className:
                'img-circle', src: message.image }),
              _react2.default.createElement(
                'div',
                { className: 'bubble-img-' + bubbleClass },
                _Parser(text)
              ),
              _react2.default.createElement(
                'div',
          ...
          return _react2.default.createElement(
            ...
            _react2.default.createElement(
              'div',
              { className: 'bubble-link bubble ' + bubbleClass },
              _Parser(text)
            ),
            _react2.default.createElement(
              'div',
          ...
          return _react2.default.createElement(
            ...
            _react2.default.createElement(
              'div',
              { className: 'bubble text-content' + bubbleClass },
              message.text
            ),
            _react2.default.createElement(
              'div',
