  ...
  _createClass(ChatBubble, [{
    ...
    value: function getConversations(component, messages) {
      ...
      var listItems = messages.map(function (message, index) {
        if (message.contentType !== 'close_room') {
          var bubbleClass = 'you';
          var bubbleDirection = '';
          ...
          if (message.contentType != '') {
            if (message.contentType.indexOf('image') !== -1) {
              ...
              text = '<img src="' + component.props.base_url + message.downloadURL + '" style="width: ' + width.toString() + 'px; height: ' + height.toString() + 'px; border-radius: 15px">';
            } else if(message.contentType.indexOf('file') !== -1) {
              text = '<i class="fa fa-cloud-download" aria-hidden="true"></i>' + '<a target="_blank" href="' +
                component.props.base_url + message.downloadURL + '">' + message.name + '</a>';
            }
          } else {
            var textobj;
            var emoji;
          ...
          if (text != '') {
            if (isImageTag) {
              return _react2.default.createElement('div', { className: 'bubble-container ' + bubbleDirection, key: index }, _react2.default.createElement('img', { className: 'img-circle ' + bubbleClass, src: message.type === 1 ? component.props.base_url + component.state.targetUser.avatar.url : component.props.base_url + component.state.currentUser.avatar.url }), _react2.default.createElement('div', { id: component.renderHastag ? 'tag_' + message.mid : message.mid, className: 'bubble-img img-' + bubbleClass }, _Parser(text)), _react2.default.createElement('div', { className: component.renderHastag ? 'menu-box' : 'menu-box-hidden' }, _react2.default.createElement('div', { className: 'tools tools--hidden' }, _react2.default.createElement('div', { className: 'tool',
            ...
            return _react2.default.createElement('div', { className: 'bubble-container ' + bubbleDirection, key: index }, _react2.default.createElement('img', { className: 'img-circle ' + bubbleClass, src: message.type === 1 ? component.props.base_url + component.state.targetUser.avatar.url : component.props.base_url + component.state.currentUser.avatar.url }), _react2.default.createElement('div', { id: component.renderHastag ? 'tag_' + message.mid : message.mid, className: 'bubble-link bubble ' + bubbleClass }, _Parser(text)), _react2.default.createElement('div', { className: component.renderHastag ? 'menu-box' : 'menu-box-hidden' }, _react2.default.createElement('div', { className: 'tools tools--hidden' }, _react2.default.createElement('div', { className: 'tool',
              onClick: component.handleHashTagToolClick.bind(messID) }, _Parser(hashTagItem))), _react2.default.createElement(_hashTagInput.WithContext, { tags: message.tags,
              handleDelete: component.handleDeleteTag.bind(messObj),
              handleAddition: component.handleAdditionTag.bind(messObj),
              handleDrag: component.handleDragTag.bind(component) }), _react2.default.createElement('div', { onClick: component.handleEllipsClick.bind(messID) }, _Parser(ellipsItem))), _react2.default.createElement('div', { className: 'time-' + bubbleClass }, timeFormatted));
            ...
            if (elements.length > 0) {
              if (!allIsEmoji) {
                return _react2.default.createElement('div', { className: 'bubble-container ' + bubbleDirection, key: index }, _react2.default.createElement('img', { className: 'img-circle ' + bubbleClass,
                  src: message.type === 1 ? component.props.base_url + component.state.targetUser.avatar.url : component.props.base_url + component.state.currentUser.avatar.url }), _react2.default.createElement('div', { id: component.renderHastag ? 'tag_' + message.mid : message.mid, className: 'bubble ' + bubbleClass }, elements.map(function (element) {
                ...
                return _react2.default.createElement('div', { className: 'bubble-container ' + bubbleDirection, key: index }, _react2.default.createElement('img', { className: 'img-circle ' + bubbleClass, src: message.type === 1 ? component.props.base_url + component.state.targetUser.avatar.url : component.props.base_url + component.state.currentUser.avatar.url }), _react2.default.createElement('div', { className: 'bubble-emoji bubble-emoji-' + bubbleClass }, elements.map(function (element) {
                  if (element.type == 'emoji') {
            ...
            return _react2.default.createElement('div', { className: 'bubble-container ' + bubbleDirection, key: index }, _react2.default.createElement('img', { className: 'img-circle ' + bubbleClass, src: message.type === 1 ? component.props.base_url + component.state.targetUser.avatar.url : component.props.base_url + component.state.currentUser.avatar.url }), _react2.default.createElement('div', { id: component.renderHastag ? 'tag_' + message.mid : message.mid, className: 'bubble ' + bubbleClass }, _react2.default.createElement('p', { className: 'text-content' }, message.content)), _react2.default.createElement('div', { className: component.renderHastag ? 'menu-box' : 'menu-box-hidden' }, _react2.default.createElement('div', { className: 'tools tools--hidden' }, _react2.default.createElement('div', { className: 'tool',
              onClick: component.handleHashTagToolClick.bind(messID) }, _Parser(hashTagItem))), _react2.default.createElement(_hashTagInput.WithContext, { tags: message.tags,
              handleDelete: component.handleDeleteTag.bind(messObj),
              handleAddition: component.handleAdditionTag.bind(messObj),
              handleDrag: component.handleDragTag.bind(component) }), _react2.default.createElement('div', { onClick: component.handleEllipsClick.bind(messID) }, _Parser(ellipsItem))), _react2.default.createElement('div', { className: 'time-' + bubbleClass }, timeFormatted));
