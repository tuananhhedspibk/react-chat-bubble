  ...
  _createClass(ChatBubble, [
    ...
    },
    {
      ...
      value: function handleEllipsClick() {
        ...
        var hashTagBox = _jquery('#tag_' + this).next('.menu-box')
    ...
    },
    {
      ...
      value: function getConversations(component, messages) {
        ...
        var listItems = messages.map(function (message, index) {
          ...
          if (message.contentType != '') {
            ...
            while (match = regex.exec(message.content)) {
              ...
              if ((match.index + match[2].length + 1) <  message.content.length) {
                lastString = message.content.substring(match.index + match[2].length + 1,
          ...
          let timeStamp = new Date(parseFloat(message.msgTimeStamp));
          var options = {
          ...
          if (text != '') {
            if (isImageTag) {
              return _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'div',
                  { id: component.renderHastag ? 'tag_'+message.mid:message.mid, className: 'bubble-img img-' + bubbleClass },
                  _Parser(text)
                ),
                _react2.default.createElement(
                  'div',
            ...
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                'div',
                { id: component.renderHastag ? 'tag_'+message.mid:message.mid , className: 'bubble-link bubble ' + bubbleClass },
                _Parser(text)
              ),
              _react2.default.createElement(
                'div',
            ...
            if(elements.length > 0) {
              if(!allIsEmoji) {
                return _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    'div',
                    { id: component.renderHastag ? 'tag_'+message.mid:message.mid, className: 'bubble ' + bubbleClass },
                    elements.map(element => {
